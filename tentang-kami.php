            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="shadow p-3 mb-5 bg-white rounded">
                        <h3 class="text-center font-weight-bold mb-3">Tentang Kami</h3>
                        
                        <p style="text-indent: 1rem;">
                            Jajanan Mas Di Mas menjual segala jenis kue yang dibuat dengan bahan yang sehat serta berkualitas. Tentunya dijual dengan harga yang sangat terjangkau bagi semua kalangan.

                            Segala menu yang dibuat adalah homemade dan kami membuatnya sendiri
                        </p>
                        <div class="d-flex justify-content-center">
                            <div class="p-2"> <i class="fa fa-instagram" aria-hidden="true"></i>  @jajanan_masdimas </div>
                            <div class="p-2">|</div>
                            <div class="p-2"><i class="fa fa-phone" aria-hidden="true"></i> 081111653234</div>
                          </div>
                    </div>
                </div>
            </div>
